...
function Banner({ catRef }) {
  ...
  return (
    <main className="relative flex items-center justify-between bg-[--theme-color] ">
      <section className='absolute text-center inset-0 flex flex-col justify-top items-start p-4 mt-[80px] md:mt-[50px]'>
        <h1 className="hidden md:block w-full py-3 text-3xl font-semibold sm:text-7xl lg:text-8l ">
          SUNBUN
        </h1>
        <h1 className="hidden md:block w-full py-3 text-[8px]  sm:text-4xl ">
          Let's Elevate Your Frame Game
        </h1>
        <p className=" hidden md:block md:py-3  justify-center items-start text-[7px]  text-amber-200 font-semibold md:text-3xl text-grey-300 absolute top-[255px] md:top-[545px] left-[127px] md:left-[200px]">
      ...
      <section className="absolute top-[282px] md:top-[490px] left-[160px] md:left-[550px] ">
      ...
      <section className='absolute  hidden md:block top-[355px] md:top-[703px] left-[0px] md:left-[110px] '>
