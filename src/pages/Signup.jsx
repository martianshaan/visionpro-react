...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      await signupHandler(userDetails.email, userDetails.password);
      navigate('/login');
    } catch (error) {
...
// function Signup() {
//   const { signingup, signupHandler } = useAuthContext();
...
//       </figure>
//       <div className="">
//         <section className="px-7 py-7 rounded-md shadow-md bg-white/[0.75]
// flex flex-col gap-6 max-w-lg ml-20  max-h-min my-6"
//         >
//           <Logo />
//           <section className="flex flex-col gap-3">
//             <h1 className="text-4xl font-bold text-center">Sign lup</h1>
//             {error && <p>{error}</p>}
