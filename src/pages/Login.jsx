...
export default function Login() {
  ...
  return (
    <div className="grid  grid-rows-1 lg:grid-cols-2 w-full  m-auto justify-center h-screen">
      ...
      bg-white/[0.75] flex flex-col gap-6  ml-20
     max-w-lg max-h-min "
      >
        <Logo />
        ...
        <form className="flex flex-col  gap-3 mt-2" action="" onSubmit={handleSubmit}>
